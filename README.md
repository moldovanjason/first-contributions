...
forked the repo and added it to my local vscode and added it to my repo collection.
added my contribution to the application.
...
<kbd>[<img title="中文 (Simplified)" alt="中文 (Simplified)" src="https://cdn.staticaly.com/gh/hjnilsson/country-flags/master/svg/cn.svg" width="22">]
  more to add 
  (translations/README.chs.md)</kbd>
